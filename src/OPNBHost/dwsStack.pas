...
type
   ...
   TStackMixIn = record
      ...
      public
         ...
         procedure Assign(const Source: TStackMixIn); // added
...
// added
procedure TStackMixIn.Assign(const Source: TStackMixIn);
var
  SrcDC: IDataContext;
  k: integer;
begin
  ...
  FParams  := Source.FParams;
  FMaxSize := Source.FMaxSize;
  Initialize(FParams);

  FSize         := Source.FSize;
  FStackPointer := Source.FStackPointer;
  FBasePointer  := Source.FBasePointer;
